...
angular.module('app', ['ionic', 'app.controllers', 'app.routes', 'app.directives', 'app.services'])
  ...
  .run(function ($ionicPlatform, $rootScope, $http, $log, loginService) {
    ...
    $rootScope.ticketToRide = function () {
      ...
      if (($rootScope.luminate.tr_info.typeName === "Cyclist") && ($rootScope.luminate.tr_part_progress.raised < "3000")) {
    ...
    $rootScope.refresher = function () {
      ...
      loginService.getLogin($rootScope.luminate.username, $rootScope.luminate.password);
